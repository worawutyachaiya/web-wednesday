...
<head>
    ...
    <title>A03</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/a03.png" alt="">
                <img src="image/list/a03-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>A03</span></div>
                <div class="name">หลวงปู่โต๊ะ รุ่น ปิดตาจัมโบ้ 2 ปี 2521-2523</div>
                <div class="content">
                    ...
                    จำนวนการจัดสร้าง : <span>34,974 เหรียญ</span><br>
                    หมายเลข : <span>-</span><br>
                    สภาพ : <span>70%</span>
                    <div class="price">ราคา : <span>70,000</span> บาท</div>
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=3'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
