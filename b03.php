...
<head>
    ...
    <title>B03</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/b03.png" alt="">
                <img src="image/list/b03-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>B03</span></div>
                <div class="name">หลวงพ่อพัฒน์ รุ่น เศรษฐีรวยสมปรารถนา ปี 2563</div>
                <div class="content">
                    เนื้อ : <span>ทองแดงซาติน</span><br>
                    ลงยา : <span>จีวรส้ม</span><br>
                    ชนิดวัตถุมงคล : <span>เหรียญ</span><br>
                    ปลุกเสก : <span>วัดห้วยด้วน อำเภอหนองบัว จังหวัดนครสวรรค์</span><br>
                    จำนวนการจัดสร้าง : <span>19,900 เหรียญ</span><br>
                    หมายเลข : <span>224</span><br>
                    สภาพ : <span>99%</span>
                    <div class="price">ราคา : <span>150</span> บาท</div>    
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=19'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
