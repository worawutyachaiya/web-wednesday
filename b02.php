...
<head>
    ...
    <title>B02</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/b02.png" alt="">
                <img src="image/list/b02-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>B02</span></div>
                <div class="name">หลวงพ่อพัฒน์ รุ่น ปิดตาทันใจ168 ปี 2564</div>
                <div class="content">
                    เนื้อ : <span>3K</span><br>
                    ลงยา : <span>-</span><br>
                    ชนิดวัตถุมงคล : <span>องค์</span><br>
                    ปลุกเสก : <span>วัดห้วยด้วน อำเภอหนองบัว จังหวัดนครสวรรค์</span><br>
                    จำนวนการจัดสร้าง : <span>5,000 องค์</span><br>
                    หมายเลข : <span>143</span><br>
                    สภาพ : <span>99%</span>
                    <div class="price">ราคา : <span>300</span> บาท</div>    
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=18'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
