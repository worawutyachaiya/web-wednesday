...
<head>
    ...
    <title>B11</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/B11.png" alt="">
                <img src="image/list/B11-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>B11</span></div>
                <div class="name">หลวงพ่อทองอยู่ รุ่น หลังเสือ ปี 2519</div>
                <div class="content">
                    ...
                    จำนวนการจัดสร้าง : <span>8,900 เหรียญ</span><br>
                    หมายเลข : <span>-</span><br>
                    สภาพ : <span>80%</span>
                    <div class="price">ราคา : <span>2,100</span> บาท</div>    
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=27'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
