...
<head>
    ...
    <title>A15</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/a15.png" alt="">
                <img src="image/list/a15-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>A15</span></div>
                <div class="name">หลวงปู่โต๊ะ รุ่น ปิดตาปลดหนี้หลังยันต์ตรี ปี 2521-2523</div>
                <div class="content">
                    เนื้อ : <span>ผงใบลานบรรจุตะกรุดเดี่ยว</span><br>
                    ลงยา : <span>-</span><br>
                    ชนิดวัตถุมงคล : <span>องค์</span><br>
                    ปลุกเสก : <span>วัดประดู่ฉิมพลี แขวงวัดท่าพระ จังหวัดกรุงเทพมหานคร</span><br>
                    จำนวนการจัดสร้าง : <span>18,600 องค์</span><br>
                    หมายเลข : <span>-</span><br>
                    สภาพ : <span>80%</span>
                    <div class="price">ราคา : <span>85,000</span> บาท</div>    
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=15'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
