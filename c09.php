...
<head>
    ...
    <title>C09</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/c09.png" alt="">
                <img src="image/list/c09-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>C09</span></div>
                <div class="name">หลวงพ่อพัฒน์ รุ่น ชนะจน 99 ปี 2562</div>
                <div class="content">
                    เนื้อ : <span>2k</span><br>
                    ลงยา : <span>ชมพู</span><br>
                    ...
                    หมายเลข : <span>842</span><br>
                    สภาพ : <span>90%</span>
                    <div class="price">ราคา : <span>1,200</span> บาท</div>    
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=37'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
