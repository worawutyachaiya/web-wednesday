...
<head>
    ...
    <title>C04</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/c04.png" alt="">
                <img src="image/list/c04-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>C04</span></div>
                <div class="name">หลวงปู่หลิว ปณุณโก รุ่น รวมพุทธคุณ ปี 2538</div>
                <div class="content">
                    เนื้อ : <span>เงิน(เลี่ยมทอง 80%)</span><br>
                    ลงยา : <span>-</span><br>
                    ชนิดวัตถุมงคล : <span>เหรียญ</span><br>
                    ปลุกเสก : <span>วัดไร่แตงทอง อำเภอกำแพงแสน จังหวัดนครปฐม</span><br>
                    จำนวนการจัดสร้าง : <span>1,000 เหรียญ</span><br>
                    หมายเลข : <span>-</span><br>
                    สภาพ : <span>80%</span>
                    <div class="price">ราคา : <span>12,000</span> บาท</div>
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=32'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
