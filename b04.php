...
<head>
    ...
    <title>B04</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/b04.png" alt="">
                <img src="image/list/b04-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>B04</span></div>
                <div class="name">หลวงพ่อพัฒน์ รุ่น มงคล100ปี ปี 2564</div>
                <div class="content">
                    เนื้อ : <span>นวะหน้ากากเงิน</span><br>
                    ลงยา : <span>ลงยาแดงขอบขาว</span><br>
                    ...
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=20'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
