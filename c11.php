...
<head>
    ...
    <title>C11</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/c11.png" alt="">
                <img src="image/list/c11-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>C11</span></div>
                <div class="name">หลวงพ่อเฉลิม ผละปญุโญ รุ่น ชนะจน ปี 2563</div>
                <div class="content">
                    เนื้อ : <span>ทองแดงหน้ากากทองทิพย์</span><br>
                    ลงยา : <span>-</span><br>
                    ...
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=39'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
