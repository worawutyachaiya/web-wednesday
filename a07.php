...
<head>
    ...
    <title>A07</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/a07.png" alt="">
                <img src="image/list/a07-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>A07</span></div>
                <div class="name">หลวงพ่อคูณ รุ่น เจริญพรบน ปี 2536</div>
                <div class="content">
                    ...
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=7'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
