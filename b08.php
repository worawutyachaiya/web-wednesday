...
<head>
    ...
    <title>B08</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/b08.png" alt="">
                <img src="image/list/b08-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>B08</span></div>
                <div class="name">ท้าวเวสุวรรณวัดจุฬามณี รุ่น องค์บูชาหน้าเทพ ปี 2561</div>
                <div class="content">
                    ...
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=24'">Add to cart</button> 
                    </div> 
                </div>
            </div>
            <div class="history">
