...
<head>
    ...
    <title>D02</title> <link rel="stylesheet" href="main.css">
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/d02.png" alt="">
                <img src="image/list/d02-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>D02</span></div>
                <div class="name">หลวงพ่อคูณ รุ่น พระปิดตา ปริสุทโธ ปี 2536</div>
                <div class="content">
                    เนื้อ : <span>ผงใบลาน</span><br>
                    ลงยา : <span>-</span><br>
                    ชนิดวัตถุมงคล : <span>องค์</span><br>
                    ปลุกเสก : <span>วัดบ้านไร่ อำเภอด่านขุนทด จังหวัดนครราชสีมา</span><br>
                    จำนวนการจัดสร้าง : <span>4,999 องค์</span><br>
                    หมายเลข : <span>-</span><br>
                    สภาพ : <span>80%</span>
                    <div class="price">ราคา : <span>3,000</span> บาท</div> 
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=42'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
