...
<head>
    ...
    <title>B06</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/b06.png" alt="">
                <img src="image/list/b06-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>B06</span></div>
                <div class="name">ท้าวเวสุวรรณวัดจุฬามณี รุ่น รับขวัญศิษย์</div>
                <div class="content">
                    เนื้อ : <span>ผงแดง</span><br>
                    ลงยา : <span>-</span><br>
                    ...
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=22'">Add to cart</button> 
                    </div> 
                </div>
            </div>
            <div class="history">
