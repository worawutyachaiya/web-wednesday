...
<head>
    ...
    <title>A06</title> <link rel="stylesheet" href="main.css"> 
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/a06.png" alt="">
                <img src="image/list/a06-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>A06</span></div>
                <div class="name">หลวงพ่อคูณ รุ่น พิเศษ ปี 2517</div>
                <div class="content">
                    ...
                    จำนวนการจัดสร้าง : <span>99,999 เหรียญ</span><br>
                    หมายเลข : <span>-</span><br>
                    สภาพ : <span>90%</span>
                    <div class="price">ราคา : <span>20,000</span> บาท</div>   
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=6'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
