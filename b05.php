...
<head>
    ...
    <title>B05</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/b05.png" alt="">
                <img src="image/list/b05-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>B05</span></div>
                <div class="name">ท้าวเวสุวรรณวัดจุฬามณี รุ่น บุญอีสาน</div>
                <div class="content">
                    เนื้อ : <span>ทองแดงขัดเงา</span><br>
                    ลงยา : <span>-</span><br>
                    ...
                    หมายเลข : <span>5426</span><br>
                    สภาพ : <span>90%</span>
                    <div class="price">ราคา : <span>400</span> บาท</div>   
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=21'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
