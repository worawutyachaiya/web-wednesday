...
<head>
    ...
    <title>A04</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/a04.png" alt="">
                <img src="image/list/a04-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>A04</span></div>
                <div class="name">หลวงพ่อพัฒน์ รุ่น แรก ปี 2535</div>
                <div class="content">
                    ...
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=4'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
