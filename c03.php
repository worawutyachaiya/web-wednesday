...
<head>
    ...
    <title>C03</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/c03.png" alt="">
                <img src="image/list/c03-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>C03</span></div>
                <div class="name">หลวงปู่หลิว ปณุณโก รุ่น พระบูชา ปี 2539</div>
                <div class="content">
                    เนื้อ : <span>ทองแดง</span><br>
                    ลงยา : <span>-</span><br>
                    ชนิดวัตถุมงคล : <span>รูปหล่อ (9 นิ้ว)</span><br>
                    ปลุกเสก : <span>วัดไร่แตงทอง อำเภอกำแพงแสน จังหวัดนครปฐม</span><br>
                    จำนวนการจัดสร้าง : <span>200 องค์</span><br>
                    หมายเลข : <span>-</span><br>
                    สภาพ : <span>80%</span>
                    <div class="price">ราคา : <span>2,500</span> บาท</div>
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=31'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
