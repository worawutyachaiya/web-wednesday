...
<head>
    ...
    <title>C07</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/c07.png" alt="">
                <img src="image/list/c07-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>C07</span></div>
                <div class="name">หลวงพ่อรวย ปาสาทิโก รุ่น อายุยืน ปี 2555</div>
                <div class="content">
                    เนื้อ : <span>อัลปาก้า</span><br>
                    ลงยา : <span>-</span><br>
                    ...
                    หมายเลข : <span>621</span><br>
                    สภาพ : <span>90%</span>
                    <div class="price">ราคา : <span>1,500</span> บาท</div>
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=35'">Add to cart</button> 
                    </div>
                </div>
            </div>
            <div class="history">
