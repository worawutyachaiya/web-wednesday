...
<head>
    ...
    <title>A14</title> <link rel="stylesheet" href="main.css"> <link rel="icon" type="image/png" href="image/logo.png"/>
</head>
...
<div id="backtop"></div>
    <div class="container_list">
        ...
        <div class="content_list">
            <div class="picture">
                <img src="image/list/a14.png" alt="">
                <img src="image/list/a14-b.png" alt="">
            </div>
            <div class="details">
                <div class="code">Code : <span>A14</span></div>
                <div class="name">หลวงปู่โต๊ะ รุ่น ปิดตาหลังเต่า ปี 2521</div>
                <div class="content">
                    ...
                    จำนวนการจัดสร้าง : <span>900 องค์</span><br>
                    หมายเลข : <span>-</span><br>
                    สภาพ : <span>80%</span>
                    <div class="price">ราคา : <span>80,000</span> บาท</div> 
                    <div class="addtocart">
                    <button onclick="window.location.href='cart.php?addtocart=14'">Add to cart</button> 
                    </div>   
                </div>
            </div>
            <div class="history">
